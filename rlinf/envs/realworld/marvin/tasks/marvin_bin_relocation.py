...
@dataclass
class BinEnvConfig(MarvinRobotConfig):
...
class MarvinBinRelocationEnv(MarvinEnv):
    ...
    def go_to_rest(self, joint_reset=False):
        ...
        self._move_action(self._marvin_state.tcp_pose)
        time.sleep(0.5)
        self._marvin_state = self._controller.get_state().wait()[0]

        # Move up to clear the slot
        reset_pose = copy.deepcopy(self._marvin_state.tcp_pose)
        reset_pose[2] += 0.10
